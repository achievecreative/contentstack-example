...
export const getServerSideProps: GetServerSideProps = async (
  ...
  const home = await stack.ContentType("home").Query().toJSON().find();

  const entry = home[0][0];
  const obj = entry as { title: string };
  console.log("🚀🚀", JSON.stringify(entry), obj.title);
